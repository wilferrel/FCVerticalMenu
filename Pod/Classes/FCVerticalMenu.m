...
- (void)showFromRect:(CGRect)rect inView:(UIView *)view belowView:(UIView *)belowView
{
    if (self.isAnimating) {
        return;
    }
    ...
    //
    [self.containerView addSubview:self.menuView];
    [belowView addSubview:self.containerView];
    //    [view insertSubview:self.containerView belowSubview:belowView];
    [belowView sendSubviewToBack:self.containerView];
...
{
    FCVerticalMenuItemCollectionViewCell *cell =
        (FCVerticalMenuItemCollectionViewCell *)[collectionView dequeueReusableCellWithReuseIdentifier:@"menuItem" forIndexPath:indexPath];
